...
int main(void) {
	...
	if(pdPASS != xTaskCreate(&input::start,		"TaaT_TBHB_Input",	configUSER_SPACE_STACK_SIZE, NULL, 1, NULL)) { while(true);}
	if(pdPASS != xTaskCreate(&output::start,	"TaaT_Output",		configUSER_SPACE_STACK_SIZE, NULL, 1, NULL)) { while(true);}
